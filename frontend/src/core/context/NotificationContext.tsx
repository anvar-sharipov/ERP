          ...
          {notifications.map((n) => {
            ...
            return (
              <motion.div
                ...
                className={`relative w-[800px] max-w-[calc(100vw-2.5rem)] rounded-2xl overflow-hidden shadow-2xl ring-1 ${cfg.ring}`}
              ...
              >
                ...
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm break-words" style={{ color: cfg.text }}>
                      {n.message}
                    </div>
                  </div>

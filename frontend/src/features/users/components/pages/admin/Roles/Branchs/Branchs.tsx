          ...
          <div className="flex flex-col gap-1">
            {(["all", "active", "inactive"] as const).map((status) => (
              <Button
                ...
                text={
                  status === "all" ? t("AllBranches") : 
                  status === "active" ? t("OnlyActive") : 
                  t("OnlyInactive")
                }
                variant="ghost"
                dark={true}

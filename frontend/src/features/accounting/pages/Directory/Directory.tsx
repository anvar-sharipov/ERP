    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700 overflow-x-auto scrollbar-hide print:hidden">
        <div className="flex min-w-max px-2">
          <NavLink to="directory-page" className={tabClass} onClick={() => playClickSound()}>
            Справочники
          </NavLink>
          ...
          <NavLink to="create-fields-for-director" className={tabClass} onClick={() => playClickSound()}>
            Создать поля (директор)
          </NavLink>
        </div>
      </div>

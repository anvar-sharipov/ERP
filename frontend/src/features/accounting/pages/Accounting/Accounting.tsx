    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700 overflow-x-auto scrollbar-hide print:hidden">
        <div className="flex min-w-max px-2">
          <NavLink to="journal" className={tabClass} onClick={() => playClickSound()}>
            journal
          </NavLink>
          <NavLink to="reports" className={tabClass} onClick={() => playClickSound()}>
            reports
          </NavLink>
          <NavLink to="analytics" className={tabClass} onClick={() => playClickSound()}>
            analytics
          </NavLink>
          <NavLink to="accounts" className={tabClass} onClick={() => playClickSound()}>
            accounts
          </NavLink>
        </div>
      </div>

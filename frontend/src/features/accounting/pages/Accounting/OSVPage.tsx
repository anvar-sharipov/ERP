...
//       <div className="space-y-4">
//         <div>
//           <h4 className="font-bold text-indigo-300 mb-2 uppercase tracking-wider">Настройки ОСВ</h4>
//           <label className="flex items-center gap-2 text-indigo-200 cursor-pointer">
//             <input type="checkbox" checked={showZero} onChange={(e) => setShowZero(e.target.checked)} className="w-4 h-4 rounded border-gray-300 text-indigo-600" />
//             Показать нулевые счета
//           </label>
//         </div>
//         <div className="pt-2 border-t border-indigo-900/30 text-indigo-400/60 space-y-1">
//           <p>Период задаётся через «Период отчётов» выше.</p>
//           <p>Только проведённые операции.</p>
//         </div>
//       </div>,
//     );
//   }, [setSidebarContent, showZero]);
...
//   return (
//     <RBACGuard isLoading={false} error={null} canView={canView} forbiddenText="Нет прав">
//       <div className="space-y-3">
//         {/* Заголовок периода */}
//         <div className="flex items-center justify-between">
//           <h2 className="text-sm md:text-lg font-bold text-gray-800 dark:text-gray-100">Оборотно-сальдовая ведомость</h2>
//           {periodFrom && periodTo && (
//             <span className="text-gray-500 dark:text-gray-400">
//               {new Date(periodFrom).toLocaleDateString("ru-RU")} — {new Date(periodTo).toLocaleDateString("ru-RU")}
//             </span>
...
//         {!periodFrom || !periodTo ? (
//           <div className="text-center py-12 text-gray-400">Укажите период в правом сайдбаре</div>
//         ) : isLoading ? (
//           <div className="text-center py-12 text-gray-400">Загрузка...</div>
//         ) : rows.length === 0 ? (
//           <div className="text-center py-12 text-gray-400">Нет данных за выбранный период</div>
//         ) : (
//           <div className="flex">
//             <div className="overflow-x-auto rounded-lg border border-green-700 dark:border-green-800 w-fit">
//               <OSVTable

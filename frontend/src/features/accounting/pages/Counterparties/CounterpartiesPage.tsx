...
//   const getTypeLabel = (type: string) => COUNTERPARTY_TYPES.find((t) => t.value === type)?.label ?? type;
...
//           <Input label="ИНН" value={form.inn} onChange={(e) => setForm((p) => ({ ...p, inn: e.target.value }))} />

...
//   return (
//     <>
//       {/* Кнопка — всегда видна на десктопе, на мобильных только когда есть контент */}
//       {sidebarContent && (
//         <button
//           onClick={() => {
//             playAside2Sound();
//             setIsOpen(!isOpen);
//           }}
//           className="fixed right-0 top-20 w-6 h-6 bg-indigo-900 border border-indigo-700 rounded-l-full flex items-center justify-center shadow-lg hover:bg-indigo-800 z-50 transition-colors lg:hidden print:!hidden"
//         >
//           <svg className={`w-4 h-4 text-indigo-300 transition-transform duration-300 ${!isOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
//             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
//           </svg>
...
//       <div className="relative flex print:hidden lg:flex">
//         {/* Кнопка для десктопа */}
//         <button
//           onClick={() => {
//             playAside2Sound();
//             setIsOpen(!isOpen);
//           }}
//           className="hidden lg:flex absolute -left-3 top-3 w-6 h-6 bg-indigo-900 border border-indigo-700 rounded-full items-center justify-center shadow-lg hover:bg-indigo-800 z-10 transition-colors"
//         >
//           <svg className={`w-4 h-4 text-indigo-300 transition-transform duration-300 ${!isOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
//             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
//           </svg>
...
//           {sidebarContent || (
//             <div className="text-indigo-400">
//               <h4>Текущая организация</h4>
//               <div>ООО "Вектор" — Основной склад</div>
//             </div>
//           )}
//         </aside>
//       </div>

...
//   const baseClass = "flex items-center justify-center gap-2 font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed rounded-[3px]";

//   const activeClasses = isActive
//     ? "bg-indigo-600 !text-white hover:bg-indigo-700"
//     : "bg-indigo-900/20 text-indigo-200 hover:bg-indigo-900/40";

//   const variants = {
//     primary: dark
//       ? "bg-indigo-900/60 text-indigo-100 border border-indigo-500/30 hover:bg-indigo-800/60"
//       : "bg-indigo-600 text-white border border-transparent hover:bg-indigo-500",
//     secondary: dark
//       ? "bg-slate-900 text-indigo-300 border border-indigo-900 hover:border-indigo-700"
...
//       : "bg-[#f5f5f5] text-[#404040] border border-[#c0c0c0] hover:bg-[#e5e5e5] shadow-sm",

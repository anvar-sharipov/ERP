...
export const ExchangeRateWidget: React.FC = () => {
  ...
  return (
    <button onClick={() => navigate(ROUTES.APP.EXCHANGE_RATES)} className="flex items-center gap-2 px-2 py-1 rounded-lg hover:bg-slate-700 transition-colors group" title="Курсы валют">
      {rates.map((rate: any) => (

...
// const COLS = [
//   { key: "code", label: "Счёт", group: null, numeric: false },
//   { key: "name", label: "Наимен.", group: null, numeric: false },
//   { key: "opening_debit", label: "Дт", group: "Сальдо начало", numeric: true },
//   { key: "opening_credit", label: "Кт", group: "Сальдо начало", numeric: true },
//   { key: "debit_turnover", label: "Дт", group: "Обороты за период", numeric: true },
//   { key: "credit_turnover", label: "Кт", group: "Обороты за период", numeric: true },
//   { key: "closing_debit", label: "Дт", group: "Сальдо конец", numeric: true },
//   { key: "closing_credit", label: "Кт", group: "Сальдо конец", numeric: true },
// ] as const;
...
//     window.addEventListener("keydown", handler);
//     return () => window.removeEventListener("keydown", handler);
//   }, [selectedCell, rows, onRowDoubleClick, scrollToRow]);

//   const thBase = "px-2 py-1.5 font-semibold text-white uppercase tracking-wider border border-green-700 dark:border-green-800 text-xs";
//   const tdBase = "px-2 py-1 text-xs border border-gray-200 dark:border-slate-600 cursor-pointer";
